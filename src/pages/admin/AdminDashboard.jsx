    ...
    return (
        <div>
            ...
            <div className="top mb-5 px-5 mt-5">
                <div className="bg-purple-50 py-5 border border-purple-100 rounded-lg flex justify-between items-center">
                    <h1 className="text-center text-2xl font-bold text-purple-500 flex-1">Admin Dashboard</h1>
                    <Link to="/" className="text-purple-500 hover:text-purple-700 font-semibold flex items-center space-x-2">
                        <svg
                        ...
                        <span className="text-lg p-2">Home</span>
                    </Link>
                </div>
            </div>
